...
def cleanup_temp_and_class_files():
    """
    Cleans up:
    - All `.class` files in TEMP_DIR and TRANSLATED_DIR.
    - All `.java` files in TEMP_DIR.
    Logs any remaining files in TEMP_DIR for verification.
    """
    try:
        # Remove all .class files in TEMP_DIR and TRANSLATED_DIR
        for folder in [TEMP_DIR, TRANSLATED_DIR]:
